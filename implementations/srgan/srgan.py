...
parser.add_argument("--dataset_name", type=str, default="Linnaeus 5 256X256_train", help="name of the dataset")
...
dataPath = GetDataPath(opt.dataset_name)
...
print("Training start time = " + str(trainingStartTime))
print("Training end time = " + str(trainingEndTime))
print("Total time (secs) = " + str(trainingEndTime - trainingStartTime))
